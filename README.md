...
![KDE Main App Menu](./kde_main_app_menu.png)
...
![Bash Terminal](./bash_terminal.png)
...
![KDE Partition Manager](./kde_partn_mgr.png)
...
![ScreenShot Options](./sc_options.jpg)

I set the save location below:

![ScreenShot Config Save Dir](./sc_cfg_save_dir.jpg)
